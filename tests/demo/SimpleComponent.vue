<template>
    <div class="sc__container">
        <h2 class="sc__container-title">A Simple Component Build</h2>
        ...
        <p>Quisque facilisis tellus nisl, vitae imperdiet nunc consectetur a. In vel fermentum tortor. In eu leo gravida, semper ipsum vitae, convallis felis. Integer et mi pulvinar, sagittis tortor nec, finibus justo. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Morbi nibh lectus, rhoncus vitae tempus vitae, consequat vel tellus. In in neque eros. Nullam consectetur accumsan hendrerit. Aliquam finibus magna a facilisis iaculis. Vestibulum faucibus ex et turpis blandit rutrum. Aenean nec nulla augue.</p>
        <p>Sed facilisis hendrerit tristique. Nulla erat nisl, viverra id rutrum id, ornare vel ex. Praesent elementum ligula malesuada enim congue, id euismod quam porta. In augue nisl, rutrum vitae hendrerit id, cursus sed nisi. Fusce id est vel nunc consectetur ornare id sit amet lacus. Morbi tempor velit quis augue molestie, nec placerat nibh consequat. Praesent risus ex, suscipit sit amet laoreet quis, congue vitae felis. Quisque lobortis, ligula id tincidunt gravida, dui orci euismod nunc, vitae commodo lacus augue varius justo.</p>
    </div>
</template>
